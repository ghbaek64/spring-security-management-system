CREATE SEQUENCE GRANT_ACCESS_RULE_SEQ;

CREATE TABLE GRANT_ACCESS_RULE
(
	ACCESS_RULE_SRL     NUMBER NOT NULL,
	PATTERNS            VARCHAR2 NOT NULL ,
	METHODS             VARCHAR2(150) NULL ,
	ROLE_NAMES          VARCHAR2(150) NULL ,
...
CREATE SEQUENCE GRANT_RULE_PERMIT_SEQ;
